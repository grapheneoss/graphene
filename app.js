...
console.log(chalk.grey("Pulling branches!"))
console.log(chalk.grey("You are running version 18.11.5"))
console.log(chalk.grey("Webserver started!"))
